package com.company.processtest.core.app;
...
@ManagedBean("ProcessTest_ExtDeployer")
public class ExtDeployer extends AbstractDeployer implements ExtDeployerMBean {
    ...
    protected void checkForFirstInit() {
        ...
        try {
            ...
            List<Config> configs = em.createQuery("select c from sys$Config c where c.name='ProcessTest.initDefaultInFirstStart'",
                ...
                if (StringUtils.isNotBlank(edition) && Integer.parseInt(edition) > 1) {
                    ...
                    if (initDefaultInFirstStart == null) {
                        try {
                            ...
                            config.setName("ProcessTest.initDefaultInFirstStart");
                        ...
                        try {
                            login();
                            em.createQuery("update sys$Config c set c.value='false' where c.name='ProcessTest.initDefaultInFirstStart'",
    ...
    protected void executeInitScripts() {
        ...
        File folderDB = new File(dbDirPath + "/50-ProcessTest/init/" + dbmsType);
